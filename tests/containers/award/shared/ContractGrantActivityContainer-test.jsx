...
jest.mock("../../../../src/js/components/keyword/table/ResultsTableErrorMessage", () => jest.fn(() => null));
jest.mock("../../../../src/js/components/keyword/table/ResultsTableLoadingMessage", () => jest.fn(() => null));
