...
import awardIDReducer from 'redux/reducers/search/awardIDReducer';
...
describe('awardIDReducer', () => {
    it('should return the initial state by default', () => {
        expect(
            awardIDReducer(undefined, {})
        ).toEqual(initialState);
    });

    describe('SET_AUTOCOMPLETE_AWARD_IDS', () => {
        it('should return a new instance of the Award IDs PIID object', () => {
            const action = {
            ...
            const updatedState = awardIDReducer(undefined, action);

            // the value should be equal
            expect(updatedState.piid).toEqual(action.awardIDs.piid);
            // but it should be its own instance
            expect(updatedState.piid).not.toBe(action.awardIDs.piid);
        });

        it('should return a new instance of the Award IDs FAIN object', () => {
            const action = {
                type: 'SET_AUTOCOMPLETE_AWARD_IDS',
                awardIDs: {
                    fain: [{
            ...
            // the value should be equal
            expect(updatedState.fain).toEqual(action.awardIDs.fain);
            // but it should be its own instance
            expect(updatedState.fain).not.toBe(action.awardIDs.fain);
        });

        it('should return a new instance of the Award IDs URI object', () => {
            const action = {
                type: 'SET_AUTOCOMPLETE_AWARD_IDS',
                awardIDs: {
                    uri: [{
            ...
            // the value should be equal
            expect(updatedState.uri).toEqual(action.awardIDs.uri);
            // but it should be its own instance
            expect(updatedState.uri).not.toBe(action.awardIDs.uri);
        });

        it('should return a new instance of the Award IDs Parent Award PIID object', () => {
            const action = {
                type: 'SET_AUTOCOMPLETE_AWARD_IDS',
                awardIDs: {
                    parent_award__piid: [{
            ...
            // the value should be equal
            expect(updatedState.parent_award__piid).toEqual(action.awardIDs.parent_award__piid);
            // but it should be its own instance
            expect(updatedState.parent_award__piid).not.toBe(action.awardIDs.parent_award__piid);
        });
    });
});
