...
const mockPeriods = [
    {
        submission_reveal_date: moment().subtract('1', 'd'),
        submission_fiscal_month: 2,
        submission_fiscal_year: 2020
    },
    {
        submission_reveal_date: moment().subtract('1', 'y'),
        submission_fiscal_month: 3,
        submission_fiscal_year: 2019
    },
    {
        submission_reveal_date: moment().subtract('2', 'y'),
    ...
    {
        submission_reveal_date: moment().add('6', 'm'),
