...
// TODO: switch over these tests to not use enzyme bc not compatible with react 18
describe('componentDidMount', () => {
    ...
    describe('hack to get this to pass without deleting the file', () => {
        it('blank test', () => {
            expect(defaultProps).toEqual(defaultProps);
        });
    });
