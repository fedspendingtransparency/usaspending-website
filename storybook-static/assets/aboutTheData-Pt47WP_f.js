...
import { Ai as formatMoneyWithPrecision, Ar as ds, Hn as isCancel, Ii as init_moneyFormatter, Ir as ps, Kr as FontAwesomeIcon, Ni as formatNumber, Nr as init_index_es, Vn as init_axios, Vr as ss, dn as init_apiRequest, go as require_jsx_runtime, io as useSelector, no as init_es, oo as useDispatch, qr as init_dist, sn as require_react_aria_modal, un as apiRequest, xr as Ka } from "./index.js-Dk2VDaPz.js";
import { O as init_accountActions, S as init_esm, T as format, a as formatUnlinkedDataRows, b as periodToQuarterMapping, d as init_aboutTheDataHelper, h as showQuarterText, i as formatReportingDifferencesData, k as setSubmissionPeriods, m as renderDeadline, n as formatMissingAccountBalancesData, r as formatPublicationDates, t as convertDatesToMilliseconds, v as init_timeFilters } from "./aboutTheDataHelper-C-4K4CA_.js";
import { d as init_accountHelper, s as init_account, t as fetchAllSubmissionDates, u as getSubmissionDeadlines } from "./account-DzCFQMYa.js";
...
var import___vite_browser_external, getTotalBudgetaryResources, getAgenciesReportingData, getSubmissionPublicationDates, fetchPublishDates, fetchMissingAccountBalances, fetchReportingDifferences, fetchAgency, fetchUnlinkedData;
var init_agencyReporting = __esmMin((() => {
	import___vite_browser_external = require___vite_browser_external();
	init_apiRequest();
	getTotalBudgetaryResources = (fy = "", period = "") => {
		if (fy && period) return apiRequest({ url: `v2/references/total_budgetary_resources/?${(0, import___vite_browser_external.stringify)({
			fiscal_period: period,
			fiscal_year: fy
		})}` });
		return apiRequest({ url: `v2/references/total_budgetary_resources/` });
	};
	getAgenciesReportingData = (fy, period, sort, order, page, limit, filter = "") => apiRequest({ url: `v2/reporting/agencies/overview/?${(0, import___vite_browser_external.stringify)({
		fiscal_year: fy,
		fiscal_period: period,
		page,
		limit,
	...
	getSubmissionPublicationDates = (fy, sort, order, page, limit, searchTerm) => apiRequest({ url: `v2/reporting/agencies/publish_dates?${(0, import___vite_browser_external.stringify)({
		fiscal_year: fy,
		page,
		limit,
		order,
	...
	fetchPublishDates = (agencyCode, fiscalYear, fiscalPeriod, params) => apiRequest({ url: `v2/reporting/agencies/${agencyCode}/${fiscalYear}/${fiscalPeriod}/submission_history/?${(0, import___vite_browser_external.stringify)(params)}` });
	fetchMissingAccountBalances = (agencyCode, params) => apiRequest({ url: `v2/reporting/agencies/${agencyCode}/discrepancies/?${(0, import___vite_browser_external.stringify)(params)}` });
	fetchReportingDifferences = (agencyCode, params) => apiRequest({ url: `v2/reporting/agencies/${agencyCode}/differences/?${(0, import___vite_browser_external.stringify)(params)}` });
	fetchAgency = (agencyCode, params) => apiRequest({ url: `v2/reporting/agencies/${agencyCode}/overview/?${(0, import___vite_browser_external.stringify)(params)}` });
