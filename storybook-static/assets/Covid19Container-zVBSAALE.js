...
import { At as setAppliedFilterCompletion, Bi as init_searchFiltersReducer, Dt as applyStagedFilters, G as init_bulkDownloadActions, Gn as init_queryParams, Ha as Link, Hr as tc, Ii as init_moneyFormatter, It as clearAllFilters, J as setDownloadExpectedFile, Kr as FontAwesomeIcon, La as init_useQueryParams, Lr as rc, Lt as init_searchFilterActions, Nr as init_index_es, Oa as init_IsMobileContext, Ot as init_appliedFilterActions, Pr as lc, Ra as useQueryParams, Ri as CheckboxTreeSelections, Un as combineQueryParams, Va as init_development, Vi as initialState, Wn as getQueryParamString, X as setDownloadPending, Y as setDownloadExpectedUrl, cr as init_socialShare, d as requestFullDownload, dr as Analytics, er as getEmailSocialShareData, fn as init_modalActions, fr as init_Analytics, go as require_jsx_runtime, gr as $s, io as useSelector, ir as slug, ki as formatMoney, kt as resetAppliedFilters, l as init_downloadHelper, mt as init_GlobalModalContainer, n as init_Loading, no as init_es, nr as init_covid19, oo as useDispatch, or as getBaseUrl, pn as showModal, pt as GlobalModalContainer_default, q as setDownloadCollapsed, qa as useNavigate, qr as init_dist, sr as handleShareOptionClick, t as LoadingWrapper, vr as Es, wr as Qs } from "./index.js-Dk2VDaPz.js";
import { D as init_metaTagHelper, L as HelmetExport, R as init_Helmet, m as covidPageMetaTags } from "./HeaderContainer-CiRwnRgy.js";
...
import { C as fetchAwardAmounts, P as init_disaster, b as setOverview, g as resetOverview, h as init_covid19Actions, j as fetchOverview, n as useDefCodes, t as init_WithDefCodes, v as setDefcParams, x as setTotals } from "./WithDefCodes-BotSvVWk.js";
import { a as jumpToSection, i as init_covid19Helper, o as componentByCovid19Section, s as init_covid19$1 } from "./covid19Helper-B5EnUrHl.js";
...
var init_Heading = __esmMin((() => {
	...
	Heading = ({ publicLaw, url, onShareOptionClick }) => {
						...
						/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Qs, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)($s, {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(GlobalModalContainer_default, {})
								]
							})
						}),
