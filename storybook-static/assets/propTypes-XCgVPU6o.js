...
//#region src/js/propTypes/index.js
var AWARD_OVERVIEW_PROPS, AWARD_COUNTS_PROPS, AWARD_TYPE_PROPS, AWARD_AMOUNT_TYPE_PROPS, AWARD_SECTION_PROPS, AWARD_PAGE_WRAPPER_PROPS, AWARD_SECTION_HEADER_PROPS, awardOverviewAwardAmountsSectionBase, contract, AWARD_OVERVIEW_AWARD_AMOUNTS_SECTION_PROPS, AWARD_AGGREGATED_AMOUNTS_PROPS, LATEST_PERIOD_PROPS, SUBMISSION_PERIOD_PROPS;
var init_propTypes = __esmMin((() => {
	AWARD_OVERVIEW_PROPS = PropTypes.shape({
	...
	AWARD_AMOUNT_TYPE_PROPS = PropTypes.oneOf([
		"idv",
		"contract",
		"grant",
		"loan",
	...
	AWARD_OVERVIEW_AWARD_AMOUNTS_SECTION_PROPS = PropTypes.shape({ ...contract });
	AWARD_AGGREGATED_AMOUNTS_PROPS = PropTypes.shape({
	...
	LATEST_PERIOD_PROPS = PropTypes.shape({
		year: PropTypes.number,
		quarter: PropTypes.number,
		period: PropTypes.number,
		latestSubmissionDate: PropTypes.object
	});
	SUBMISSION_PERIOD_PROPS = PropTypes.arrayOf(PropTypes.shape({
...
//#endregion
export { AWARD_OVERVIEW_PROPS as a, AWARD_SECTION_PROPS as c, SUBMISSION_PERIOD_PROPS as d, init_propTypes as f, AWARD_OVERVIEW_AWARD_AMOUNTS_SECTION_PROPS as i, AWARD_TYPE_PROPS as l, AWARD_AMOUNT_TYPE_PROPS as n, AWARD_PAGE_WRAPPER_PROPS as o, AWARD_COUNTS_PROPS as r, AWARD_SECTION_HEADER_PROPS as s, AWARD_AGGREGATED_AMOUNTS_PROPS as t, LATEST_PERIOD_PROPS as u };
