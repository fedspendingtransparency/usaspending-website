...
var abs, atan2, cos, max, min, sin, sqrt, pi$1, halfPi, tau$1;
...
var init_circle = __esmMin((() => {
	init_math();
	circle_default = { draw(context, size) {
...
var init_cross = __esmMin((() => {
	init_math();
	cross_default = { draw(context, size) {
...
var init_diamond = __esmMin((() => {
	...
	tan30 = sqrt(1 / 3);
	tan30_2 = tan30 * 2;
	diamond_default = { draw(context, size) {
...
var init_square = __esmMin((() => {
	init_math();
	square_default = { draw(context, size) {
		const w = sqrt(size);
		const x = -w / 2;
...
var init_star = __esmMin((() => {
	init_math();
	ka = .8908130915292852;
	kr = sin(pi$1 / 10) / sin(7 * pi$1 / 10);
	kx = sin(tau$1 / 10) * kr;
	ky = -cos(tau$1 / 10) * kr;
	star_default = { draw(context, size) {
...
var init_triangle = __esmMin((() => {
	init_math();
	sqrt3 = sqrt(3);
	triangle_default = { draw(context, size) {
...
var init_wye = __esmMin((() => {
	init_math();
	c = -.5;
	s = sqrt(3) / 2;
	k = 1 / sqrt(12);
	a = (k / 2 + 1) * 3;
	wye_default = { draw(context, size) {
		const r = sqrt(size / a);
		const x0 = r / 2, y0 = r * k;
...
var init_linearClosed = __esmMin((() => {
	init_noop();
...
//#endregion
export { init_area as $, init_basis as A, square_default as B, init_linearClosed as C, basisClosed_default as D, init_basisOpen as E, init_triangle as F, circle_default as G, init_diamond as H, triangle_default as I, bumpY as J, init_circle as K, init_star as L, init_symbol as M, init_wye as N, init_basisClosed as O, wye_default as P, area_default as Q, star_default as R, monotoneY as S, basisOpen_default as T, cross_default as U, diamond_default as V, init_cross as W, init_pie as X, init_bump as Y, pie_default as Z, step_default as _, silhouette_default as a, init_arc as at, init_monotone as b, init_stack as c, none_default as d, init_line as et, init_none$1 as f, stepBefore as g, stepAfter as h, init_silhouette as i, arc_default as it, Symbol as j, basis_default as k, stack_default as l, init_step as m, init_wiggle as n, init_linear as nt, expand_default as o, init_src$1 as ot, none_default$1 as p, bumpX as q, wiggle_default as r, linear_default as rt, init_expand as s, init_src as t, line_default as tt, init_none as u, init_natural as v, linearClosed_default as w, monotoneX as x, natural_default as y, init_square as z };
