...
//#endregion
//#region src/js/helpers/colorHelper.js
var lightestAcceptableLumeForWhiteText, labelColorFromBackground;
var init_colorHelper = __esmMin((() => {
	init_tinycolor();
	lightestAcceptableLumeForWhiteText = (targetContrast) => 1.05 / targetContrast - .05;
	labelColorFromBackground = (backgroundColor) => {
		const targetContrast = 4.6;
		const backgroundLumeMax = lightestAcceptableLumeForWhiteText(targetContrast);
		const backLume = tinycolor(backgroundColor).getLuminance();
		if (backLume <= backgroundLumeMax) return "#ffffff";
		const sRGB = ((backLume + .05) / targetContrast - .05) / 1;
		let rawR = sRGB * 12.92;
		if (rawR > .03928) rawR = sRGB ** (1 / 2.4) * 1.055 - .055;
		return tinycolor({
			r: rawR * 255,
			g: rawR * 255,
			b: rawR * 255
...
//#endregion
//#region src/js/components/sharedComponents/TreemapCell.jsx
/**
* TreemapCell.jsx
* Created by Kevin Li 8/17/17
*/
var import_jsx_runtime, propTypes, TreemapCell;
var init_TreemapCell = __esmMin((() => {
	init_colorHelper();
	...
	TreemapCell = ({ width, height, x, y, color, title, subtitle, data, selectedCell, showTooltip, hideTooltip, goToUnreported, highlightColor = "#fdb81e" }) => {
		...
		let cellTitle = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", {
		...
		let cellValue = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", {
			...
			ref: elementRef,
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: title.text }),
...
//#endregion
export { init_TreemapCell as n, TreemapCell as t };
