...
import { $a as init_GlobalConstants, Ai as formatMoneyWithPrecision, Ar as ds, Bi as init_searchFiltersReducer, Bn as init_Icons, C as getFiscalYearsWithLatestAndAll, Di as calculateUnitForSingleValue, Dn as Close, E as isFyValid, Ea as require_immutable, Gn as init_queryParams, Ha as Link, Hn as isCancel, Ii as init_moneyFormatter, Ka as useMatch, Kr as FontAwesomeIcon, La as init_useQueryParams, Li as unitValues, Mi as formatMoneyWithUnitsShortLabel, Ni as formatNumber, Nr as init_index_es, O as require_dayjs_min, Oi as calculateUnits, Pi as formatNumberWithPrecision, Pn as InfoCircle, Qa as globalConstants, Ra as useQueryParams, S as earliestFiscalYear, T as init_fiscalYearHelper, Tr as Vs, Un as combineQueryParams, Va as init_development, Vi as initialState, Vn as init_axios, Wn as getQueryParamString, Wr as ws, at as init_index_esm, cr as init_socialShare, dn as init_apiRequest, dr as Analytics, fn as init_modalActions, fr as init_Analytics, gn as AngleDown, go as require_jsx_runtime, gr as $s, it as Q, ki as formatMoney, lo as bindActionCreators, n as init_Loading, no as init_es, oo as useDispatch, or as getBaseUrl, ot as le, pn as showModal, pr as init_stickyHeader, qa as useNavigate, qr as init_dist, sn as require_react_aria_modal, so as connect_default, sr as handleShareOptionClick, t as LoadingWrapper, un as apiRequest, uo as init_redux, v as convertFYToDateRange, vi as BaseRecipientOverview, w as getTrailingTwelveMonths, wr as Qs, y as currentFiscalYear, yi as init_BaseRecipientOverview } from "./index.js-Dk2VDaPz.js";
import { D as init_metaTagHelper, N as recipientPageMetaTags } from "./HeaderContainer-CiRwnRgy.js";
...
import { N as init_InfoTooltipContent$1, i as CondensedCDTooltip } from "./InfoTooltipContent-BmV8PlBe.js";
import { D as performSpendingOverTimeSearch, _ as generateUrlHash, w as performSpendingByCategorySearch, y as init_searchHelper } from "./searchHelper-C3Qi4x1J.js";
...
import { i as init_BaseStateCategoryResult, n as init_TopFive, o as init_topCategories, r as BaseStateCategoryResult, s as recipientCategories, t as TopFive } from "./TopFive-DlHQYCAf.js";
