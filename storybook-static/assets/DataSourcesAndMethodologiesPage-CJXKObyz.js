...
import { Fn as init_stickyHeaderHelper, Fr as init_dist, Jn as getBaseUrl, Mn as getQueryParamString, Nn as init_queryParams, Oa as init_development, Pa as useNavigate, Pn as getStickyBreakPointForSidebar, Pr as FontAwesomeIcon, Ta as useQueryParams, Ua as init_es, Xn as init_socialShare, Yn as handleShareOptionClick, en as init_modalActions, jn as combineQueryParams, ka as Link, qa as useDispatch, ro as require_jsx_runtime, tn as showModal, tr as init_stickyHeader, wa as init_useQueryParams } from "./index.js-CgeUxZJy.js";
import { D as init_metaTagHelper, u as agencySubmissionDataSourcesMetaTags } from "./HeaderContainer-DuB8bISr.js";
...
//#region src/js/components/agencySubmissionStats/DataSourcesAndMethodologiesPage.jsx
/**
* Created by Max Kendall
* 02/18/2021
*/
var import_jsx_runtime, emailData, DataSourcesAndMethodologiesPage;
//#endregion
__esmMin((() => {
	init_dist();
	init_development();
	...
	DataSourcesAndMethodologiesPage = () => {
		...
		useEffect(() => {
			if (query.section) jumpToSection(query.section);
		}, [query.section]);
		useEffect(throttle(() => {
			let isMounted = true;
			if (isMounted) {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									...
									id: "submissions-statistics-dsm-using_this_table",
									children: [
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
													...
													children: "OMB’s Memorandum M-20-21 (Appendix A, Section III)."
												}),
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
													...
													children: ["‘Resources for Federal Agencies and Data Analysts’ page.\xA0", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FontAwesomeIcon, { icon: "external-link-alt" })]
												})
											] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Calculation:" }) }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The data in the column reflects the most recent date that the agency published a financial data submission for the selected fiscal year and period." })
										]
									})]
								}, "submissions-statistics-dsm-most_recent_update"),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									className: "about-section-wrapper",
									id: "submissions-statistics-dsm-missing_tas",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "about-section-title",
										children: "Number of TASs Missing from Account Balance data"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "about-section-content",
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Calculation:" }) }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The numbers in the column are based on the difference between the count of the agency’s (non-financing account) TASs in GTAS and the count of the agency’s TASs in File A. Note that financing TASs are excluded from this calculation as they do not involve budgetary spending; thus, while present in GTAS, they are not appropriate for publication on USAspending.gov." })
										]
									})]
								}, "submissions-statistics-dsm-missing_tas"),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									className: "about-section-wrapper",
									id: "submissions-statistics-dsm-obligations_discrepancies",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "about-section-title",
										children: "Reporting Difference in Obligations"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "about-section-content",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "This column shows the total difference in agency spending (i.e., obligations) between two sets of data submitted to USAspending.gov (i.e., File A and File B). The accompanying modal provides the exact difference per TAS." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "You may find this column and related modal helpful if you notice discrepancies when comparing different parts of USAspending.gov. On some pages, high-level spending visuals use File A data, while those that dive into program activities or object classes use File B data. For example, you may notice differences within some Federal Account profiles given that the “Snapshot” and “Spending Over Time” sections draw on File A, while “Spending by Category” draws on File B." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "File A data is validated against GTAS to ensure it matches at the TAS level. While File B data is intended to match the TAS-level totals in the File A and GTAS data, it can diverge. Agencies are presented with warning notifications when submitting data that does not match, and they can provide explanations to delineate the source of the discrepancy. If provided, those explanations can be found within the downloads in the “Agency Comments” column." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Calculation:" }) }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "The numbers in this column are based on the difference between obligations for the agency’s TASs in File A and File B for the current reporting period. This can be replicated by comparing obligations_incurred for the agency’s TASs in the Account Balances (File A) and Account Breakdown by Program Activity & Object Class (File B) in the Custom Account Download." })
										]
									})]
								}, "submissions-statistics-dsm-obligations_discrepancies"),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
									className: "about-section-wrapper",
									id: "submissions-statistics-dsm-unlinked_awards",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "about-section-title",
										children: "Number of Unlinked Awards"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "about-section-content",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "These columns show how many awards that pertain to the selected submission period are “unlinked.” Unlinked awards lack a shared award ID that allows two systems to match their records. Agencies submit two distinct datasets to USAspending for awards—File C and File D, parts 1 and 2. File C is submitted and published on the site on a monthly or quarterly basis from audited agency financial systems. File D1 (procurement) and File D2 (financial assistance) data is separately submitted (ingested from the Federal Procurement Data System, in the case of procurement data) and published on the site up to daily from agency assistance or procurement systems. Because these data originate from different communities and different systems within agencies that are subject to different policies and reporting requirements, there are sometimes gaps between the awards captured in each dataset. " }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "When an award is linked, USAspending uses each dataset to add context both on-screen and in downloads. Examples: " }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "On the Award Summary pages we leverage linked account data from File C and D1/D2 to display the federal accounts, object classes, and program activities that funded an award." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "The Account Breakdown by Award data that can be found in Custom Account Downloads page includes information about the award recipient sourced from the Contract Awards and Assistance Awards data." })] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "In contrast, an unlinked award (e.g., a financial assistance award that is present in File C but cannot be linked to File D2) will not have an Award Summary page or recipient information in the download." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "You may find this column useful if you seek to determine how complete an agency’s award information is on the site. As explained above, unlinked awards only show up in some parts of the site and are missing their full context." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Calculation:" }) }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "For each column, the numbers are based on the sum of two counts:" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
												className: "about-section-content__numbered-list",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "The count of the agency’s D1 or D2 awards with activity in the selected submission period (i.e., action_date in the period) that aren’t linked to any of the agency’s File C awards across all time." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "The count of the agency’s File C awards with obligation activity in the selected submission period that aren’t linked to any D1 or D2 awards across all time. Obligation activity is defined as having non-null values in the Transaction Obligated Amount column. (Note that rows with null obligation activity are rows with outlay balance data.)" })]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "For financial assistance data, this calculation excludes loans with total_subsidy_cost that is less than or equal to zero, since such loans have no budgetary cost to the government and therefore should not be reported in File C. Note that this column is concerned with unlinked awards that had obligation activity in the selected period or quarter, but the linkage itself occurs at the Award ID level across time. This means that if there is a time gap between when an award is reported between these two datasets, it will not prevent an award from being linked; such awards will show up in this count." })
										]
									})]
								}, "submissions-statistics-dsm-unlinked_awards"),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
									className: "about-section-wrapper",
									id: "submissions-statistics-dsm-agency_comments",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "about-section-content",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
												className: "about-section-title",
												children: "Agency Comments"
											}),
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "You may find this download helpful if you wish to learn additional context for the values you see in the preceding columns." }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Refer to the table below to determine which file’s comments may provide additional context for a column:" }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Column Name" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Relevant File" })] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tbody", { children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "Number of TASs Missing from Account Balance Data" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "File A" })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "Reporting Difference in Obligations" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "File A, File B" })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "Number of Unlinked Contract Awards" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "File C, File D1" })] }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "Number of Unlinked Assistance Awards" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: "File C, D2" })] })
											] })] })
										]
									})
								}, "submissions-statistics-dsm-agency_comments")
							]
						})
					})
				})
