...
const NLSidebarButtons = ({
    sidebarContent, setSidebarIsOpen, sidebarIsOpen, setSidebarContent, isMedium
}) => {
    if (isMedium) return;
        ...
        <div className={"sidebar-nl-buttons-container"}>
            ...
            <button
                ...
                className={`sidebar-nl-buttons ${
                    sidebarContent === 'filters' && sidebarIsOpen  ? 'selected' : ''
                }`}
                onClick={(e) => {
            ...
            { QAT &&
                <button
                    ...
                    className={`sidebar-nl-buttons ${
                        sidebarContent === 'natural language' && sidebarIsOpen ? 'selected' : ''
                    }`}
                    onClick={(e) => {
