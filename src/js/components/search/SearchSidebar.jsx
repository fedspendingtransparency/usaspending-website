        ...
        <div
            ...
            <div className="sidebar-header">
                ...
                <div className="sidebar-paragraph__container">
                    <div className="sidebar-paragraph">Learn which data elements are associated with certain search filters<TooltipWrapper icon="info" tooltipPosition="bottom" tooltipComponent={FilterTooltip} /></div>
                </div>
            </div>
