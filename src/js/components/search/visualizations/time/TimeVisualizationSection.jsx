        ...
        <div className="visualization-top">
          <div className="visualization-description">
            <div className="content">
              Spot trends in spending over your chosen time period. Break down
              your results by years, quarters, or months, and hover over the
              bars for more detailed information.
            </div>
          </div>
          <div className="visualization-period">
            ...
            <div className="download">
              ...
              <FontAwesomeIcon icon="info-circle" className="info" />
            </div>
          </div>
        </div>
        <TimeVisualization
