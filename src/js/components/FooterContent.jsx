...
const FooterContent = memo(function FooterContent() {
    const { isLargeScreen, isTablet } = useWindowWidth();
                        ...
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    href="https://fiscal.treasury.gov/">
                ...
                <div className="footer-social-media-section">
                    <ul>
                        <li>
                            <button
                                onClick={generateOnClick(
                                    "https://www.youtube.com/channel/UCyDn83O-0XC98H3TCV-VCGQ"
                                )}
                                title="Youtube">
                                <FontAwesomeIcon
                                    icon={["fab", "youtube"]}
                        ...
                        <li>
                            <button
                                onClick={generateOnClick(
                                    "https://www.facebook.com/fiscalservice/"
                                )}
                                title="Facebook">
                                <FontAwesomeIcon
                        ...
                        <li>
                            <button
                                onClick={generateOnClick(
                                    "https://www.linkedin.com/company/bureau-of-the-fiscal-service/"
                                )}
                                title="LinkedIn">
                                <FontAwesomeIcon
                                    icon={["fab", "linkedin"]}
