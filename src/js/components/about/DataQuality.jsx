...
const DataQuality = ({ onExternalLinkClick }) => (
    <div
        ...
        <h3 className="about-subtitle">The Government Accountability Office (GAO) has identified the need to disclose the following two items:</h3>
        <div className="about-section-content">
            <ul>
                <li>
                    GSA’s FPDS delays publishing procurement (i.e., contract and IDV) data for the Department of Defense
                    (DOD) and U.S. Army Corps of Engineers (USACE) in order to address potential DOD operational
                    tempo issues, delaying the availability of procurement, account breakdown by award (File C),
                ...
                <li>
                    ...
                    lump sum payments, with each record corresponding to the amount of money sent to a specific Medicare
                    Administrative Contractor (MAC) in a given month. The recipient location and primary place of
