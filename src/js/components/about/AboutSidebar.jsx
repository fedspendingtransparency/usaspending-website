/**
 * AboutSidebar.jsx
 * Created by Michael Bray 11/21/2017
 */
...
import SidebarLink from '../agency/sidebar/SidebarLink';
...
export default class AboutSidebar extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div>
                <div
                    className={`about-sidebar-reference ${floatSidebar}`}
                    ref={(div) => {
                ...
                <div
                    className={`about-sidebar-content ${floatSidebar}`}
                    ref={(div) => {
                        this.div = div;
                    }}>
                    <ul>
...
AboutSidebar.propTypes = propTypes;
