            ...
            <div className="aligned-heading">
                {publicLaw === 'american-rescue-plan' ?
                    <div className="heading__description">
                        ...
                        <p>
                            <button className="usa-button-link" onClick={jumpToDataSources}>Visit our Data Sources & Methodology</button> section to learn more about the underlying data, downloading the data, and resources about COVID-19 from other agencies.
                        </p>
                    </div>
                    :
                    <div className="heading__description">
