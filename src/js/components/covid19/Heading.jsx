    ...
    return (
        <div className="heading__container information-body">
            ...
            <div className="heading__description">
                ...
                <ReadMore>
                    <p>
                        In response to guidance from the Office of Management and Budget (OMB), we updated our data model to capture the journey of COVID-19 dollars from appropriation to <span className="glossary-term">obligation</span> <GlossaryLink term="obligation" /> and <span className="glossary-term">outlay</span> <GlossaryLink term="outlay" /> by federal agencies.<sup>1 2</sup> See who received funding, which agencies spent the funds, which programs were funded, and more.
                    </p>
                    <p>
                        Visit our <button className="usa-button-link" onClick={jumpToDataSources}>Data Sources & Methodology</button> and <button className="usa-button-link" onClick={jumpToDataSources}>Other Resources</button> sections to learn more about the underlying data and find resources about COVID-19 from other agencies.
                    </p>
