        ...
        <div className="body__content budget-categories">
            ...
            <div className="body__narrative-description">
                ...
                <ReadMore>
                    ...
                    <p>Please note that Small Business Administration (SBA) loan programs are categorized as follows:
                        <ul>
                            <li className="outer-list">&#32;Federal Account 073-1154: Business Loans Program Account, Small Business Administration
                                <ul>
                                    <li className="inner-list">&#32;Paycheck Protection Program (PPP) loans constitute the majority of this account</li>
                                    <li className="inner-list">&#32;EIDL loans constitute the minority of this account</li>
                                </ul>
                            </li>
                            <li className="outer-list">&#32;Federal Account 073-1152: Disaster Loans Program Account, Small Business Administration
                                <ul>
                                    <li className="inner-list">&#32;EIDL loans constitute the entirety of this account</li>
                                </ul>
                            </li>
                        </ul>
                    </p>
