        ...
        <FlexGridRow>
            <FlexGridCol desktop={{
                ...
                <main className="main-content">
                    <heading className="main_heading">Analyzing Equity in Federal COVID-19 Spending: The Opportunity Project</heading>
                    ...
                    <p />
                    <p>Questions, ideas or feedback? E-mail us at usaspending@fiscal.treasury.gov</p>
                    <p>We want to thank everyone involved in The Opportunity Project.  Learn more at <a href="http://www.opportunity.census.gov/">opportunity.census.gov</a></p>
                </main>
            </FlexGridCol>
        </FlexGridRow>
    </PageWrapper>
