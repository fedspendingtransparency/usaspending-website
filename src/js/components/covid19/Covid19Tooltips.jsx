    ...
    <div className="covid-profile-tt">
        ...
        <div className="tooltip__text">
            ...
            <ol className="tooltip_list">
                <li>
                    <strong>Face Value of Loans:</strong> the amount that agencies have directly issued (for direct loans) or facilitated by compensating the lender if the borrower defaults (for loan guarantees).
                    <ol type="a" className="tooltip_list__sub">
                        <li>
                            Face Value of Loans is not considered federal spending from a budget perspective, since it does not in itself represent a long-term cost to the government. As a result, Face Value of Loans is not included in any obligation or outlay figure.
                        </li>
                    </ol>
                </li>
                <li>
                    <strong>Loan Subsidy Cost:</strong> the calculated net present value of the loan or loan guarantee to the government, taking into account the size of the loan (i.e., its face value), interest rate, and the modeled risk of the recipient failing to pay back the loan in part or full.
                    <ol type="a" className="tooltip_list__sub">
                        <li>
                        ...
                        <li>
                            Loan Subsidy Cost does have direct budgetary impact and is factored into obligations and outlays when it is positive.
                        </li>
                        <li>
                            Administrative costs of running the loan or loan guarantee program itself are excluded from Loan Subsidy Cost calculations.
                        </li>
                    </ol>
                </li>
            </ol>
