            ...
            {dataDisclaimerBanner !== 'hide' && (
                <div className={`info-banner data-disclaimer${isBannerSticky ? ' sticky-banner' : ''}`}>
                    ...
                    <div className="info-banner__content">
                        ...
                        <p>
                            There are limitations to the data on this page and some features are not yet available. Learn more about these limitations and upcoming updates by clicking <button onClick={() => {}}>here</button>.
                        </p>
                    </div>
                </div>
            )}
