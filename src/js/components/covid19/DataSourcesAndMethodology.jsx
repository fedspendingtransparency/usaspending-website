...
const DataSourcesAndMethodology = ({ publicLaw }) => (
    <div className="dsm__container">
        ...
        <div className="dsm__topSection">
            ...
            <p><strong>Download Data: </strong>The data downloads will include all data displayed on this page (as well as many additional data elements), with the exception of a few aspects one would need the more granular Account Breakdown by Award data (File C) to reproduce. If you wish to download this more granular data, visit the{' '}<Link to="/download_center/custom_account_data"><strong>Custom Account Data</strong></Link> download page.</p>
            <p><Link to="/disaster/covid-19/data-sources"><strong>Learn more about our data sources and calculation methods</strong></Link>, including details about our COVID-19 download options.</p>
            {publicLaw === 'american-rescue-plan' ?
                <div />
                :
                <p>USAspending is working with federal agencies to address known limitations in COVID-19 spending data. See a <a target="_blank" href="data/data-limitations.pdf" rel="noopener noreferrer"><strong>full description</strong></a> of this issue.</p>
            }
        </div>
    </div>
);
