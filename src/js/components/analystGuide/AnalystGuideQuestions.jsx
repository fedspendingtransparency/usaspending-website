...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">More information about these identifiers is available online.</p>
        <p className="analyst-guide__answerStyle">The Award ID filter on Advanced Search can be used to filter award spending by the PIID, FAIN and URI data elements. These data elements are important components of prime award summary identifier information.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Data Dictionary and the Custom Account Data Dictionary.</p>
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Award Type filter on Advanced Search can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Data Dictionary and the Custom Account Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Award Amount filter on Advanced Search can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Data Dictionary and the Custom Account Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
},
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Award Amount filter on Advanced Search can be used to filter award spending by loan subsidy cost.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide. </p>
    </>)
}];
...
const dataAccessQuestions = [{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">These files are available through the Custom Account Data download feature.</p>
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Assistance_PrimeTransactions and Contract_PrimeTransactions files are available through the Advanced Search and Custom Award Data download features. For Advanced Search, both files are returned if the level of data is set to “Transaction.” For Custom Award Data, the Assistance_PrimeTransactions file is returned if the Award Type filter includes “Grants,” “Direct Payments,” “Loans,” “Insurance,” or “Other Financial Assistance.” The Contracts_PrimeTransactions file is returned if the Award Type filter includes “Contracts” or “Contract IDVs.” </p>
        <p className="analyst-guide__answerStyle">The Assistance_Delta, Assistance_Full, Contracts_Delta and Contracts_Full files are available through the Award Data Archive download feature. The Assistance_Full and Assistance_Delta files are returned if the Award Type is set to “Financial Assistance.” The Contracts_Full and Contracts_Delta files are returned if the Award Type is set to “Contracts.”</p>
        ...
        <p className="analyst-guide__answerStyle">More information about the columns in these files is available in the Data Dictionary and throughout this guide.</p>
    </>)
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Assistance_PrimeAwardSummaries and Contracts_PrimeAwardSummaries files are available through Advanced Search and the COVID-19 Spending profile page download features. For Advanced Search, these files are both returned if the level of data is set to “Award.”</p>
...
},
{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">The API page on USAspending offers general API guidance, tutorials, request recipes, and more. A list of endpoints is available online. The download files described above are available through the API.</p>
    </>)
},
{
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
}, {
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Funding Agency filter on Advanced Search can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
}, {
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">The Agency Profile page can be used to browse detailed information on agencies.</p>
        <p className="analyst-guide__answerStyle">The awarding agency filter on Advanced Search can be used to filter award spending by agency data elements.</p>
        <p className="analyst-guide__answerStyle">The agency filter on Custom Account Download can be used to download account spending data by agency.</p>
        <p className="analyst-guide__answerStyle">The agency filter on Award Data Archive can be used to download account spending data by agency.</p>
        <p className="analyst-guide__answerStyle">The agency and sub-agency filters on Custom Award Data can be used to download account spending data by agency.</p>
    </>)
}, {
...
const accountDataQuestions = [{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The TAS filter on Advanced Search can be used to filter award spending by TAS.</p>
        <p className="analyst-guide__answerStyle">The Treasury Account Symbol chart in the Spending by Category section of Federal Account Profile pages display all Treasury accounts associated with a federal account. </p>
    </>)
},
{
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The TAS filter on Advanced Search can be used to filter award spending by these data elements. </p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
},
{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">The Federal Account Profile can be used to browse detailed information on federal accounts.</p>
        <p className="analyst-guide__answerStyle">The TAS filter on Advanced Search can be used to filter award spending by these data elements. </p>
        <p className="analyst-guide__answerStyle">The federal account filter on Custom Account Download can be used to download account spending data by federal account.</p>
    </>)
},
{
...
},
{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">The fiscal year and quarter filter on the Custom Account Data download feature can be used to download account spending from 2017 to present. For data before 2017, you can see similar information in the Office of Management and Budget (OMB) budget appendices.</p>
    </>)
}];
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The PSC and NAICS filters on Advanced Search can be used to filter award spending by these data elements. </p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
}];
...
},
{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">There are a few ways to access DEFC spending on USAspending. The DEFC filter on Advanced Search can be used to filter award spending by this data element. All COVID-19 spending is included in on our COVID-19 Spending profile page. Finally, account spending can be downloaded by DEFC using Custom Account Download.</p>
    </>)
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Custom Account Data download DEFC filter can be used to filter award download files by DEFC.</p>
        <p className="analyst-guide__answerStyle">The COVID-19 Spending profile page download can be used to download all COVID-19 spending.</p>
        <p className="analyst-guide__answerStyle">The DEFC filter on Advanced Search can be used to filter award spending by this data element. </p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide. </p>
    </>)
}];
...
const assistanceListingQuestions = [{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">Assistance listings are detailed public descriptions of federal programs that provide grants, loans, scholarships, insurance, and other types of assistance awards. Assistance Listings were formally referred to as the Catalog of Federal Domestic Assistance (CFDA). Only financial assistance spending includes Assistance Listings information; contract spending does not. More information about Assistance Listings is available on sam.gov. </p>
    </>)
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Advanced Search CFDA Program filter can be used to filter award spending by assistance listing.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
}];
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">By April of 2022, the federal government will have stopped using the DUNS number to uniquely identify entities. At that point, entities doing business with the federal government will use UEI. More information about the DUNS to UEI transition is available online.</p>
    </>)
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Advanced Search Recipient filter can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
},
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The only recipient type categories available in Advanced Search which apply to financial assistance recipients are: </p>
        <ul>
...
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Recipient Location filters on Advanced Search can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
},
{
    ...
    answer: (<>
        ...
        <p className="analyst-guide__answerStyle">The Place of Performance filters on Advanced Search can be used to filter award spending by these data elements.</p>
        <p className="analyst-guide__answerStyle">More information about these fields is available in the Custom Account Data Dictionary and the Data Dictionary.</p>
        <p className="analyst-guide__answerStyle">More information on how to download data from USAspending is available in the HOW TO ACCESS THE DATA section of this guide.</p>
    </>)
}];
...
const additionalResources = [{
    ...
    answer: (<>
        <p className="analyst-guide__answerStyle">The Glossary lists plain-language definitions of terms used throughout USAspending.</p>
        <p className="analyst-guide__answerStyle">The Data Dictionary defines data elements included in the various download files available on USAspending.</p>
        <p className="analyst-guide__answerStyle">The FPDS Data Dictionary includes descriptions of terminology related to contract data.</p>
    </>)
},
{
    question: "What other resources are available to help understand the data in USAspending?",
    answer: (<>
        <p className="analyst-guide__answerStyle">The github wiki provides information for developers on how the USAspending application works.</p>
        <p className="analyst-guide__answerStyle">The USAspending&apos;s FAQ page provides additional advice for getting the most out of the site.</p>
        <p className="analyst-guide__answerStyle">The DATA Act Information Model Schema (DAIMS) page provides more information on various systems related to the data in USAspending.</p>
        </>)
}];
