...
const AnalystGuideIntro = () => (
    <>
        <h3 className="analyst-guide__topTitle">What is Federal Spending Guide?</h3>
        <div className="analyst-guide__bodyText">
            ...
            <p>If you'd like to recommend a question to be added to this guide, please share it on our <a href="https://fiscalservice.force.com/usaspending/s/" alt="Community Page">Community page</a> or send an email to <a href="mailto:USAspending.Help@fiscal.treasury.gov">USAspending.Help@fiscal.treasury.gov</a> We look forward to hearing from you!
            </p>
        </div>
    </>
);
