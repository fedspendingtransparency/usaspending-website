...
const ErrorWordOfTheDay = () => (
    <div className="word-of-the-day__error-message">
        ...
        <button className="word-of-the-day-error-button" onClick={() => window.location = 'mailto:usaspending.help@fiscal.treasury.gov?subject=Word%20of%20the%20Day%20Error'}>Report this error</button>
    </div>
);
