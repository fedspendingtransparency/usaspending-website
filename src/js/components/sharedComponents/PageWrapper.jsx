...
const PageWrapper = ({
    ...
    <div className={classNames} ref={ref}>
        ...
        {sections && inPageNav && <InPageNav sections={sections} activeSection={activeSection} pageName={pageName} rootMargin={rootMargin} detectActiveSection jumpToSection={jumpToSection} />}
        </>}
