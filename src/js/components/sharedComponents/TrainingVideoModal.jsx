        ...
        <div className="usa-dt-modal training-video-modal">
            ...
            <div className="usa-dt-modal__body">
                ...
                <FlexGridCol
                    ...
                    <iframe width="100%" height="100%" src={`https://www.youtube.com/embed/${props.id}`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
                </FlexGridCol>
            </div>
        </div>
    </Modal>
