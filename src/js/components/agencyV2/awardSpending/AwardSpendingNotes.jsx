...
const AwardSpendingNotes = () => (
    <div className="award-spending__notes-wrapper">
        <div className="award-spending__notes-text">
            <b>NOTE:</b> The sub-agencies presented in this section represent awarding organizations and were sourced from the General Services Administration (GSA) Federal Hierarchy (available at{' '}
            <a href="https://sam.gov/content/hierarchy" target="_blank" rel="noopener noreferrer">https://sam.gov/content/hierarchy</a>
