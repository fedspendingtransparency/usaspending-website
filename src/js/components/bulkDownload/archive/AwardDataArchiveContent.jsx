    ...
    render() {
        return (
            <div className="award-data-archive-content">
                ...
                <p>
                    New files are uploaded on the 15th of each month; if an agency&rsquo;s data hasn&rsquo;t changed
                    since the previous month, no new file will be added. <b>Full files</b> feature aggregate data
                    (data for the fiscal year up until the date listed), and <b>delta files</b> feature only new
                    and modified data.
                </p>
                <p>
