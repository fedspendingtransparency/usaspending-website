...
const AwardDataArchiveContent = ({
    ...
    <div className="award-data-archive-content">
        ...
        <p>
            Welcome to the <b>Award Data Archive</b>, which features major agencies&rsquo; award transaction data for full fiscal years.
            They&rsquo;re a great way to get a view into broad spending trends and, best of all, the files are already prepared &mdash; you can access them instantaneously.
        </p>
        <p>
            New files are uploaded by the 15th of each month.
            Check the Data As Of column to see the last time files were generated.
            <b>Full files</b> feature data for the fiscal year up until the date the file was prepared, and <b>delta files</b> feature only new, modified, and deleted data since the date the last month&apos;s files were generated.
