        ...
        return (
            <div className="download-filter">
                ...
                <div className="download-filter__content">
                    ...
                    <p className="download-filter__content-note"><span className="download-filter__content-note_bold">Note:</span> The data included in the Custom Account Download was first collected in the second quarter of fiscal year 2017. Financial data will not be available prior to that timeframe.</p>
