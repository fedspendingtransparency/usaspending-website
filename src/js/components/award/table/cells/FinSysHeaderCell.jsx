...
const propTypes = {
    ...
    setFinSysSort: React.PropTypes.func,
    isLastColumn: React.PropTypes.bool
};

export default class FinSysHeaderCell extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div className={`financial-system-header-cell column-${this.props.column}${lastClass}`}>
...
FinSysHeaderCell.propTypes = propTypes;
