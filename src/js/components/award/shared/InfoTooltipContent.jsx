...
export const summaryRelatedAwardsInfo = (
    <div className="award-summary-tooltip">
        ...
        <div className="tooltip__text">
            ...
            <p className="tooltip__text-section">A parent award, or parent indefinite delivery vehicle, is any award that has other prime awards made under it.</p>
            <p className="tooltip__text-section">The contract summarized on this page is a “child” prime award of the parent award indicated here.</p>
            <p className="tooltip__text-section">Click on the award ID to view the summary page of this award&apos;s parent award, which details all of that parent award&apos;s “child” and “grandchild” awards.</p>
