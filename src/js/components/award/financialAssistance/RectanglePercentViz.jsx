...
const RectanglePercentViz = ({ numerator, denominator, percentage }) => {
    // const [
    //     activeTooltip,
    //     closeTooltip,
    //     showSubsidyTooltip,
    ...
    const numeratorIsZero = (numerator === 0);
        ...
        <div className="award-amounts-viz">
            <>
                <div
                    ...
                    <strong>{numerator.value} ({percentage})</strong><br />{numerator.text}
                </div>
            ...
            <div className="award-amounts-viz__bar-wrapper">
                ...
                <div className="award-amounts-viz__bar" style={{ backgroundColor: faceValueColor, width: percentage }}>
                    {!numeratorIsZero &&
                    // <TooltipWrapper {...propsForSubsidyTooltip} styles={{ width: subsidyBarAndLabelStyles.width }}>
                        <div className="award-amounts-viz__obligated--grants" style={{ width: '100%', backgroundColor: subsidyBarAndLabelStyles.backgroundColor }} />
                        // </TooltipWrapper>
                    }
