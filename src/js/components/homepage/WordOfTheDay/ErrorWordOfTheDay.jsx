...
const ErrorWordOfTheDay = () => (
    <div className="word-of-the-day__error-message">
        ...
        <button className="word-of-the-day-error-button" onClick={() => window.location = `mailto:usaspending.help@fiscal.treasury.gov?subject=${encodeURIComponent("Word of the Day Error")}`}>Report this error</button>
    </div>
);
