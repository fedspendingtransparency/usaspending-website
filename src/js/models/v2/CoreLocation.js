...
const CoreLocation = {
    populateCore(data) {
        ...
        this._zip = (data.zip && data.zip4 && `${data.zip}-${data.zip4}`) || (data.zip5 && data.zip4 && `${data.zip5}-${data.zip4}`) || data.zip5 || (data.zip4 && data.zip4.slice(0, 5)) || data.foreignPostalCode || data.zip || '';
