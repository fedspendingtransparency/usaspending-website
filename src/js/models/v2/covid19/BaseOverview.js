...
const BaseOverview = {
    populate(data) {
        ...
        this._totalBudgetAuthority = data.total_budget_authority || 0;
        this._awardObligations = data.spending.award_obligations || 0;
        this._awardOutlays = data.spending.award_outlays || 0;
        this._totalObligations = data.spending.total_obligations || 0;
        this._totalOutlays = data.spending.total_outlays || 0;
