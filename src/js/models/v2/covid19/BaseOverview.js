...
const BaseOverview = {
    populate(data) {
        ...
        this._totalBudgetAuthority = data.total_budget_authority || null + (data.additional ? data.additional.total_budget_authority : 0);
        this._awardObligations = data.spending.award_obligations || null;
        this._awardOutlays = data.spending.award_outlays || null;
        this._totalObligations = data.spending.total_obligations || null + (data.additional ? data.additional.spending.total_obligations : 0);
        this._totalOutlays = data.spending.total_outlays || null + (data.additional ? data.additional.spending.total_outlays : 0);
