...
const remapData = (data, idField) => {
    ...
    if (data.contract_parent_id) {
        parentId = data.contract_parent_id;
    }
...
class ResultsTableAward extends GenericRecord {
...
export default ResultsTableAward;
