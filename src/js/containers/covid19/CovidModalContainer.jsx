                    ...
                    <div className="usa-dt-modal__body covid-modal-body">
                        ...
                        <div className="modal-disclaimer usa-alert-warning">
                            ...
                            <div className="modal-disclaimer__text">
                                ...
                                <p>USAspending is working with federal agencies to address known limitations in COVID-19 spending data. See <a href="data/data-limitations-v2.pdf" target="_blank" rel="noopener noreferrer">a full description</a> of the issue.</p>
                            </div>
                        </div>
