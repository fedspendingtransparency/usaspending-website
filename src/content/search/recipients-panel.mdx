...
"About the Filter 
Results are filtered by <GlossaryLink term="recipent"/>recipient (person or organization who received the award) or <GlossaryLink term="recipient/business types"/>recipient type (such as nonprofit, higher education, or minority-owned business). 
