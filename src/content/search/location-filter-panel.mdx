...
<b>About the Filter</b><br/>
Search results are filtered by <GlossaryLink term="primary-place-of-performance" />place of performance
(where the work for the award is taking place) or <GlossaryLink term="recipient-location"> recipient location </GlossaryLink> (where the awardee is geographically located).

<b>Location Data</b><br/>
Each prime award <GlossaryLink term="transaction"/> transaction includes separate fields for the place of
performance of the award as well as the business address (recipient location) of the award recipient. 
Each <GlossaryLink term="sub-award"/> subaward record includes these two location fields for the 
<GlossaryLink term="prime-award-recipient" /> and the <GlossaryLink term="sub-award"/>subaward. 
...
Learn more about congressional redistricting [link to "about the data" listing]. 
Geographical Spending Types 
