...
<div className="collapsible-sidebar--dsm-wrapper--text-section"> 
    ...
    (where the work for the award is taking place) or <GlossaryLink term="recipient-location"/> recipient location (where the awardee is geographically located).
</div>
...
<div className="collapsible-sidebar--dsm-wrapper--text-section"> 
    ...
    <GlossaryLink term="prime-award" /> prime award recipient and the <GlossaryLink term="sub-award"/> subaward. 
</div>
