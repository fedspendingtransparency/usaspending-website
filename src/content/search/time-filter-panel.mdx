...
<DsmRelatedTerms headingTitle={"Related Terms"} glossaryLinks={[{text: "Action Date", term:"action-date"},{text:"Fiscal Year (FY)",term:"fiscal-year-fy"},{text:"Period of Performance Start Date", term: "period-of-performance-start-date"},{text:"Period of Performance Current End Date", term:"period-of-performance-current-end-date"},{text: "Period of Performance Potential End Date", term:"period-of-performance-potential-end-date"}]} />