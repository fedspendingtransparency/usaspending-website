import { AboutTheDataMarkdownLink } from './AboutTheDataMarkdownLink.jsx';
...
New data must be submitted to USAspending.gov every month (for loans) for two weeks (for other assistance award types). See the entry on <AboutTheDataMarkdownLink slug="frequency-of-updates-to-prime-award-data-for-financial-assistance" name="Frequency of Updates to Prime Award Data for Financial Assistance" />.
