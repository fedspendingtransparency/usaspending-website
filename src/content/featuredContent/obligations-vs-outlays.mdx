For this series, we asked our [Transparency Experience Desk](mailto:usaspending.help@fiscal.treasury.gov) to answer the most commonly-asked questions about USAspending.gov’s open data.
...
![Obligations vs Outlays](obligations-vs-outlays.png)
...
To read more frequently-asked questions and browse the latest posts from users helping each other, visit the [USAspending Community](https://onevoicecrm.my.site.com/usaspending/s/).
